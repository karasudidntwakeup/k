...
static const char *fonts[] = { "SAGA:size=13", "SF Arabic:size=13","JetBrainsMono  NerdFont:size=13"};
static const char dmenufont[]       = "JetBrainsMono NerdFont:size=13";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_p,      setcfact,       {.f = -0.05} },
	{ MODKEY,                       XK_l,      setmfact,       {.f = +0.05} },
	{ MODKEY,                       XK_o,      setcfact,       {.f = +0.05} },
